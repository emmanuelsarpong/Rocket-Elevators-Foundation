...
# con = PG::Connection.open(host: 'server=codeboxx.cq6zrczewpu2.us-east-1.rds.amazonaws.com;port=3306;database=emmanuelsarpong;uid=codeboxx;password=Codeboxx!')
